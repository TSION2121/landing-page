  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why take  IETP Course ?</h2>
            <div className='row g-4'>
                    ...
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                                Successful teams  Received Opportunist to advance project including extra fumd
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                                Students get happy with experience  they gain in collaborating with different departments
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            <Card.Title className='text-center text-capitalize mb-3'>
                                AASTU will obtain powerful innovations
                            </Card.Title>
                            <Card.Text className='text-center'>
                                AASTU will prosper with student innovations
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
